...
extended_description:
  -
    ...
    content:
      -
        type: text
        text: 'AMEN aggregates to an unheard-of 15AWG. Four twisted pairs comprising 8 solid pure Ag strands per conductor leg.  Single-ended version uses KLE Ag RCAs, Balanced use premium Silver-Teflon XLRs.'
  -
    type: paragraph
    content:
      -
        type: text
        text: "Amenemhat III was reportedly the most benign and genial of Egypt's Twelpth Dynasty pharaohs. His statuary is portrayed with large ears as he was a good listener.  Hence the first Golden Ears?"
